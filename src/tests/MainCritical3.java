...
public class MainCritical3 {
	public static void main(String[] args){
		try {
			String name = "main3";
			int num_rand;
			ArrayList<MonObjetInterface> array = new ArrayList<MonObjetInterface>();
			MonObjet o1 = new MonObjet("objet3");
			MonObjetInterface shared_object_3 = (MonObjetInterface) JvnServerImpl.jvnGetServer().jvnCreateObject(o1);
			JvnServerImpl.jvnGetServer().jvnRegisterObject("objet3", shared_object_3);
			Thread.sleep(5000);
			...
			Thread.sleep(5000);
			JvnServerImpl.jvnGetServer().jvnRemoveObject(shared_object_3);
